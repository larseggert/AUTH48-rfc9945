...
This cornerstone of this policy is that individuals are responsible for
...
- Apply consistent, fair, and timely moderation of communication across all public
  ...
  contributions;
- Ensure appeals are available to address disagreements about moderation actions;
...
Historically, the
IETF has mainly practiced reactive moderation, with a spectrum from
